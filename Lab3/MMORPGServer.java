...
public class MMORPGServer {
    ...
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println(
                "MMORPG Server is running on port " + PORT
            );
    ...
    public static synchronized void broadcast(
        String message, PlayerHandler sender
    ) {
    ...
    public static synchronized void updatePlayerPosition(
        String playerName, String positionData
    ) {
        String message =
    ...
    public static synchronized void addPlayer(
        String playerName, PlayerHandler playerHandler
    ) {
